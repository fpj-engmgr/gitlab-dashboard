...
class MetricsService:
            ...
            "merge_requests": [
                {
                    ...
                    "web_url": mr.web_url,
                    "days_open": (datetime.utcnow() - mr.created_at).total_seconds() / 86400 if mr.state == "opened" else None,
                }
                for mr in mrs
            ]
        }
        ...
        additional_open_mrs = [
            {
                ...
                "web_url": mr.web_url,
                "days_open": (datetime.utcnow() - mr.created_at).total_seconds() / 86400,
            }
    ...
    def get_size_distribution_metrics(
        ...
        Size categories (based on actual lines changed via GraphQL):
        ...
        for mr in mrs:
            # Size based on actual lines changed (from GraphQL diffStatsSummary)
